					...
					@foreach ($results as $result) 
						<tr class="odd gradeX">
							...
							<td class="center">
								...
								{{ Form::open(array('route' => array('managers.destroy', $result->id), 'method' => 'delete', 'style' => 'display:inline-block' )) }}
                 	...
                 	<div class="row-fluid">
                      	<div class="span12">
                      		...
                      		<div class="control-group">
								...
								<div class="controls">
								  	{{  Form::text('email', '', array('class'=>'span12') ) }}
                           	...
                           	<div class="control-group">
								...
								<div class="controls">
								  	{{  Form::text('username', '', array('class'=>'span12') ) }}
								  	<span class="help-inline">
